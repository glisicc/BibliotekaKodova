...
import { useHistory, useLocation } from "react-router-dom"; //info of currently loaded page
...
const QuoteList = (props) => {
  ...
  const isSortingAsc = queryParams.get("sort") === "asc"; //becouse we have sort param in object
